...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            printWriter.print(ClassWithStatic.staticString + ' ');
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            ClassWithStatic.staticString = properties[0];
            this.i = Integer.parseInt(properties[1]);
            this.j = Integer.parseInt(properties[2]);
            reader.close();
            inputStream.close();
